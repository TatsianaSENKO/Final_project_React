	...
	return (
        <header className={`header ${location.pathname == "/" ? "header-home" : ""}`}>
            <div className="container">
                <div className="header__logo"><a href="/"><img src={logoSrc} alt="logo"/></a></div>
                    <Nav/>
                    <div className="header__icons">
                        <a className="header__account" href="#"><svg width="16" height="21" viewBox="0 0 16 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a className="header__cart" href="#"><svg width="18" height="21" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
